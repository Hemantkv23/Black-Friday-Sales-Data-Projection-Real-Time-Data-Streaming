...
def lambda_handler(event, context):
    ...
    for record in event['records']:
        ...
        try:
            ...
            payload_json = json.loads(payload) # transforming the data into json format
            ...
            transformed_data_str = json.dumps(transformed_data) + '\n' # adding a new line character after every record so that CRAWLER can parse it and crawl it
            transformed_data_encoded = base64.b64encode(transformed_data_str.encode('utf-8')).decode('utf-8') # again we are encoding it with utf-8 
